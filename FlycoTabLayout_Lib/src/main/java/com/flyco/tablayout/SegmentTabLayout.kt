...
class SegmentTabLayout @JvmOverloads constructor(private val mContext: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(mContext, attrs, defStyleAttr), ValueAnimator.AnimatorUpdateListener {
    ...
    private fun obtainAttributes(context: Context, attrs: AttributeSet?) {
        ...
        indicatorMarginLeft = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_left, dp2px(0f).toFloat())
        indicatorMarginTop = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_top, 0f)
        indicatorMarginRight = ta.getDimension(R.styleable.SegmentTabLayout_tl_indicator_margin_right, dp2px(0f).toFloat())
        ...
        mTabPadding = ta.getDimension(R.styleable.SegmentTabLayout_tl_tab_padding, (if (mTabSpaceEqual || mTabWidth > 0) dp2px(0f) else dp2px(10f)).toFloat())
    ...
    private fun updateTabStyles() {
        for (i in 0 until tabCount) {
            ...
            if (mTextAllCaps) {
                tv_tab_title.setText(tv_tab_title.text.toString().toUpperCase())
            }
